...
function enterKey(e) {
    ...
    if (e.keyCode == 13) {
        ...
        git = commands.length;
        addLine("Shashank's Portfolio:~$ " + command.innerHTML, "no-animation", 0);
...
function router(cmd){
    switch (cmd.toLowerCase()) {
        ...
        case "email":
            addLine('Opening mailto:<a href="mailto:mshashank559@gmail.com">mshashank559@gmail.com</a>...', "color2", 80);
            openNewTab(email);
            break;
